const Footer = () => {
  return (
    <>
      <div className="bg-[url(../asset/bgFooter.png)]  bg-no-repeat bg-cover bg-center w-full">
        <div className="max-w-[1140px]  w-full mx-auto items-center py-[39px]">
          ...
          <div className=" md:flex justify-between items-center ">
            ...
            <div className="text-right max-md:text-center flex flex-col underline space-y-4">
          ...
          {/* 2nd div  */}
          <div className="md:flex justify-between max-md:text-center items-center mt-[32px]">
            <a
            ...
            <div className="text-[#888888] max-sm:my-4 max-md:flex-col flex gap-[13px] lg:text-right max-sm:text-center ">
